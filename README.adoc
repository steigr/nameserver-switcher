...
image::https://qlty.sh/gh/steigr/projects/nameserver-switcher/coverage.svg[Code Coverage, link="https://qlty.sh/gh/steigr/projects/nameserver-switcher"]

image::https://qlty.sh/gh/steigr/projects/nameserver-switcher/maintainability.svg[Maintainability, link="https://qlty.sh/gh/steigr/projects/nameserver-switcher"]
