...
nameserver-switcher provides comprehensive logging capabilities with support for two output formats:
...
|`fields`
|object (optional)
|Additional structured fields specific to the log entry
|===
...
[source,json]
----
{"timemillis":1738161135123,"time":"2026-01-29T14:32:15.123456789Z","level":"INFO","message":"Starting nameserver-switcher..."}
----

**DNS request log:**
[source,json]
----
{"timemillis":1738161135456,"time":"2026-01-29T14:32:15.456789012Z","level":"INFO","message":"DNS request received","fields":{"protocol":"udp","type":"A","name":"example.com.","from":"127.0.0.1:54321"}}
----

**DNS response log:**
[source,json]
----
{"timemillis":1738161135468,"time":"2026-01-29T14:32:15.468901234Z","level":"INFO","message":"DNS response sent","fields":{"name":"example.com.","rcode":"NOERROR","answer_count":1,"resolver":"system","duration_ms":12.345,"request_matched":true}}
----

**Debug log (pattern match):**
[source,json]
----
{"timemillis":1738161135469,"time":"2026-01-29T14:32:15.469012345Z","level":"DEBUG","message":"REQUEST_PATTERN matched","fields":{"pattern":".*\\.example\\.com$","request":"example.com."}}
----

**Debug log (CNAME match):**
[source,json]
----
{"timemillis":1738161135470,"time":"2026-01-29T14:32:15.470123456Z","level":"DEBUG","message":"CNAME_PATTERN matched","fields":{"pattern":".*\\.cdn\\.example\\.com$","cname":"app.cdn.example.com."}}
----
...
[source,json]
----
{"level":"DEBUG","message":"REQUEST_PATTERN matched","fields":{"pattern":".*\\.example\\.com$","request":"foo.example.com."}}
----
...
[source,json]
----
{"level":"DEBUG","message":"CNAME_PATTERN matched","fields":{"pattern":".*\\.cdn\\.example\\.com$","cname":"app.cdn.example.com."}}
----
...
[source,json]
----
{"level":"DEBUG","message":"Queried nameserver","fields":{"resolver":"explicit"}}
----
...
[source,json]
----
{"level":"DEBUG","message":"Full response","fields":{"response":";; opcode: QUERY, status: NOERROR, id: 12345\n;; flags: qr rd ra; QUERY: 1, ANSWER: 2, AUTHORITY: 0, ADDITIONAL: 0\n..."}}
----
...
cat logs.json | jq 'select(.message == "DNS request received" and .fields.name | contains("example.com"))'

# Calculate average response time
cat logs.json | jq 'select(.message == "DNS response sent") | .fields.duration_ms' | awk '{sum+=$1; count++} END {print sum/count}'

# Count requests by resolver
cat logs.json | jq -r 'select(.message == "DNS response sent") | .fields.resolver' | sort | uniq -c

# Find slow queries (>100ms)
cat logs.json | jq 'select(.message == "DNS response sent" and .fields.duration_ms > 100)'
----
